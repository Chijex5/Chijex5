...
subject_code = input("Enter subject code: ")  # Replace this with the user input

# Extract relevant columns
df_filtered = df_students[['FULL NAME', 'MATRIC NO', subject_code]]
...
c.drawString(100, header_y, "Full Name")
c.drawString(300, header_y, "Matric No")
...
for index, row in df_filtered.iterrows():
    ...
    c.drawString(100, y_coordinate - 10, full_name)
    c.drawString(300, y_coordinate - 10, matric_no)
